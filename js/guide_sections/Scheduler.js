  ...
  render() {
    return (
      <div>
        ...
        <h3><span className="anchor" id="stamina-mode"/>Stamina mode, battery saver, etc <a
          href="#stamina-mode">#</a></h3>

        <p>Be careful when using STAMINA mode (for example, the one from Sony) or some apps called
          battery savers. If you want to use them, make sure to add Audio Profiles to their
          whitelists. Otherwise, your phone may not allow the Scheduler to work properly.</p>
      </div>
    );
  }
