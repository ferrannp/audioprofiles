  ...
  render() {
    return (
      <div>
        ...
        <img src="img/guide_silent_profile.png" />
        ...
        <img src="img/guide_phone_interruptions.png" />
        <p>That should be enough to keep your phone Silent (apart from the Alarm). But,
          ...
          'messenger_notifications'}}>Tips {'\u0026'} Tricks / Facebook Messenger </Link>
          notifications for more info on how to do that.</p>
      </div>
    );
  }
